...
CREATE TABLE orders_list (
	...
	,CONSTRAINT fk_order_list_prod_no FOREIGN KEY(prod_no)
		REFERENCES product_list(prod_no)
);

-- CREATE DATABASE MEMBER;
-- use member;

-- ALTER TABLE 테이블명 ADD CONSTRAINT fk명 foreign key (column_name);
ALTER TABLE orders_list ADD constraint fk_order_list_mem_no FOREIGN KEY(mem_no)
	REFERENCES members(mem_no);


insert INTO members (id, mem_name, addr)
VALUES ('admin', 'shinhoho', 'koear deagu');
...
ALTER TABLE orders_list DROP FOREIGN KEY fk_order_list_mem_no;
