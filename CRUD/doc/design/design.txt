...
const CONTENT_TABLE = document.querySelectorAll('.content-table td');
...
function menubar() {
    ...
    CONTENT_TABLE.forEach ( item => item.style.backgroundColor = "transparent"
    );
    ...
    function menucancle() {
        ...
        CONTENT_TABLE.forEach ( item => item.style.backgroundColor = 'rgba(243, 246, 255, 1)');
        HIDDEN1.id='hidden1';
        HIDDEN2.id='hidden2';
        HIDDEN3.id='hidden3';
        MENUTRIGGER.addEventListener('click',menubar );
